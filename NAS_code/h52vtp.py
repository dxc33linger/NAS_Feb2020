...
def h5_to_vtp(surf_file, surf_name='train_loss', log=False, zmax=-1, interp=-1, outputfilename='current'):
    ...
    if log:
        ...
        vtp_file +=  "_log"
    vtp_file +=  ".vtp"
    vtp_file = "../../results/landscape/{}.vtp".format(outputfilename)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', default='current', help='output file name')

    args = parser.parse_args()

    h5_to_vtp(args.surf_file, args.surf_name, log=args.log, zmax=args.zmax, interp=args.interp, outputfilename=args.output)
