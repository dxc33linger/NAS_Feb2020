...
parser.add_argument("--num_epoch", type=int, default = 70, help='training epochs')
...
parser.add_argument("--DNA_SIZE", type=int, default = 10, help='DNA size, i.e., number of layers within one module')  # #layers = DNA_SIZE * 3 + 2(reduction)+ 2(head-conv + FC)
